...
let name = {
    ...
    egusJCBJS85: ['Экскаватор гусеничный JCB JS 85', '/build/img/egusJCBJS85.webp', '/technics/excavatory-gusenichnye/egusJCBJS85.html'],
    egusHitachiZX1305G: ['Экскаватор гусеничный Hitachi ZX130-5G', '/build/img/egusHitachiZX1305G.webp', '/technics/excavatory-gusenichnye/egusHitachiZX1305G.html'],
    egusJCBJS130: ['Экскаватор гусеничный JCB JS 130', '/build/img/egusJCBJS130.webp', '/technics/excavatory-gusenichnye/egusJCBJS130.html'],
    egusJohnDeereE140LC: ['Экскаватор гусеничный John Deere E140 LC', '/build/img/egusJohnDeereE140LC.webp', '/technics/excavatory-gusenichnye/egusJohnDeereE140LC.html'],
    egusJCBJS145: ['Экскаватор гусеничный JCB JS 145', '/build/img/egusJCBJS145.webp', '/technics/excavatory-gusenichnye/egusJCBJS145.html'],
    egusVOLVOEC140BLC: ['Экскаватор гусеничный VOLVO EC140BLC', '/build/img/egusVOLVOEC140BLC.webp', '/technics/excavatory-gusenichnye/egusVOLVOEC140BLC.html'],
    ...
    epogNewHollandB110B: ['Экскаватор погрузчик New Holland B110B', '/build/img/epogNewHollandB110B.webp', '/technics/excavatory-pogruzchiki/epogNewHollandB110B.html'],
    epogJohnDeere325SL: ['Экскаватор погрузчик John Deere 325SL', '/build/img/epogJohnDeere325SL.webp', '/technics/excavatory-pogruzchiki/epogJohnDeere325SL.html'],
    epogJCB2CX: ['Экскаватор погрузчик JCB 2CX', '/build/img/epogJCB2CX.webp', '/technics/excavatory-pogruzchiki/epogJCB2CX.html'],
    epogJCB3CX: ['Экскаватор погрузчик JCB 3CX', '/build/img/epogJCB3CX.webp', '/technics/excavatory-pogruzchiki/epogJCB3CX.html'],
    epogJCB4CX: ['Экскаватор погрузчик JCB 4CX', '/build/img/epogJCB4CX.webp', '/technics/excavatory-pogruzchiki/epogJCB4CX.html'],
    epogHyundaiH940S: ['Экскаватор погрузчик Hyundai H940S', '/build/img/epogHyundaiH940S.webp', '/technics/excavatory-pogruzchiki/epogHyundaiH940S.html'],
    epogVolvoBL71B: ['Экскаватор погрузчик Volvo BL71B', '/build/img/epogVolvoBL71B.webp', '/technics/excavatory-pogruzchiki/epogVolvoBL71B.html'],
...
let all = {
    ...
    ekskGusenichM: {
        img: [name.egusHitachi330[1], name.egusHitachi300[1], name.egusVOLVOEC240[1], name.egusVOLVOEC240LOng[1], name.egusJCBJS130[1], name.egusJCBJS85[1], name.egusHitachiZX1305G[1], name.egusJohnDeereE140LC[1], name.egusJCBJS145[1], name.egusVOLVOEC140BLC[1]],
        title: [name.egusHitachi330[0], name.egusHitachi300[0], name.egusVOLVOEC240[0], name.egusVOLVOEC240LOng[0], name.egusJCBJS130[0], name.egusJCBJS85[0], name.egusHitachiZX1305G[0], name.egusJohnDeereE140LC[0], name.egusJCBJS145[0], name.egusVOLVOEC140BLC[0]],
        description: ['amet consectetur adipisicing elit.', 'amet consectetur adipisicing elit.', 'amet consectetur adipisicing elit.'],
        link: [name.egusHitachi330[2], name.egusHitachi300[2], name.egusVOLVOEC240[2], name.egusVOLVOEC240LOng[2], name.egusJCBJS130[2], name.egusJCBJS85[2], name.egusHitachiZX1305G[2], name.egusJohnDeereE140LC[2], name.egusJCBJS145[2], name.egusVOLVOEC140BLC[2]],
        price: [18000, 18000, 14400, 17000, 12500, 12000, 12500, 13000, 13000, 13000],
        properties: ['weight', 'bucketСapacity', 'diggingDepth', 'enginePower', 'liftingHeight'],
        weight: ['32500', '29700', '25700', '27900', '13183', '8950', '12000', '13500', '15000', '15870'],
        bucketСapacity: ['2', '2', '1.45', '0.5', '0.8', '0.35', '0.6', '0.63', '0.9', '0.66'],
        diggingDepth: ['8.18', '9.87', '14.347', '14.35', '6', '4.1', '4.5', '5.8', '6', '5.53'],
        enginePower: ['246', '246', '174', '185', '98', '72', '88.5', '114', '100', '94'],
        liftingHeight: ['7.63', '10.62', '12.579', '18.31', '4.7', '2.7', '-', '6.8-7.9', '6.32'],
    },
    ekskKolesM: {
    ...
    ekskPogrM: {
        ...
        rearBucketCapacity: ['0.18', '0.22', '0.233', '0.2', '0.21', '0.181', '0.25', '0.48', '0.8', '0.2'],
        diggingDepth: ['5.7', '5.3', '5.8', '5.78', '5.3', '3.7', '5.46', '5.88', '5.35', '5'],
        enginePower: ['101', '100', '101', '110', '93', '74', '92', '100', '75', '98'],
...
const getTechnics = (nameTechnics) => {
    for (let i = 0; i < nameTechnics.img.length; i += 1) {
        ...
        let bodyCard = $("<div class='card-body'></div")
            .append(properties)
            .append(`<div class='btn btn-information'><a href='${nameTechnics.link[i]}'>Взять в аренду</a></div>`);
